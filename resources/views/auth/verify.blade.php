...
<head>
  ...
  <title>Beauty Blog - Forgot Password</title>
  ...
  <link href="{{ asset('backendtemplate/resources/views/HomePage/css/sb-admin-2.min.css')}}" rel="stylesheet">
      ...
      <div class="col-xl-10 col-lg-12 col-md-9">
        ...
        <div class="card o-hidden border-0 shadow-lg my-5">
          <div class="card-body p-0">
            ...
            <div class="row">
              <img class="col-lg-5 d-none d-lg-block bg-image" src="{{ asset('backendtemplate/img/gg.jpg')}}">
              <div class="col-lg-6">
                <div class="p-5">
                  ...
                  <form class="user">
                    ...
                    <a href="{{ route('password.update') }}" class="btn btn-primary btn-user btn-block">
                      Reset Password
                    </a>
                  </form>
                  <hr>
