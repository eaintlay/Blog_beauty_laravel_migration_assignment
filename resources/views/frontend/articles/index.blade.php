...
@section('content')
   ...
   <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <a href="{{route('')}}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm text text-center"><i class="fas fa-plus fa-sm text-white-50"></i>Create New Article</a>
          </div>
