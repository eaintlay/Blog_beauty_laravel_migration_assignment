...
<head>
  ...
  <title>Beauty Blog Login</title>

  <!-- Custom fonts for this template-->
  <link href="{{ asset('backendtemplatevendor/fontawesome-free/css/all.min.css')}}" rel="stylesheet" type="text/css">
        ...
        <div class="card o-hidden border-0 shadow-lg my-5">
          <div class="card-body p-0">
            ...
            <div class="row">
              ...
              <img src="{{ asset('backendtemplate/img/rosy.jpg')}}" class="col-lg-5 bg-image d-none d-lg-block">
